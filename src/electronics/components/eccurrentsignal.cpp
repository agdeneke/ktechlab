...
{
    return new LibraryItem(QStringList(QString("ec/ac_current")), i18n("Current Signal"), i18n("Sources"), "currentsignal.png", LibraryItem::lit_component, ECCurrentSignal::construct);
}
    ...
    : Component(icnDocument, newItem, id ? id : "current_signal")
{
    ...
    m_currentSignal->setStep(ElementSignal::st_sinusoidal, 50., 0);
...
void ECCurrentSignal::dataChanged()
{
    ...
    m_currentSignal->setStep(ElementSignal::st_sinusoidal, frequency, 0);
